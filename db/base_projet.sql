...
--
-- Host: localhost
-- Generation Time: Aug 05, 2013 at 04:51 PM
...
INSERT INTO `catalog` (`idCatalog`, `idAbonnee`, `nomCatalog`, `dateUploadCatalog`, `nbConsult`) VALUES
(1, 14, 'monoprix', '2013-05-16 00:00:00', 13),
(2, 14, 'monoprix', '2013-05-15 00:00:00', 15),
(3, 15, 'magasin general', '2013-05-09 00:00:00', 21),
(4, 15, 'magasin general', '2013-04-06 00:00:00', 13),
(5, 13, 'carrefour', '2013-03-25 00:00:00', 35),
(6, 13, 'carrefour', '2013-02-21 00:00:00', 11),
(8, 14, 'monoprix', '2013-05-16 00:00:00', 5);
...
INSERT INTO `categories` (`idCategorie`, `nomCategorie`, `desccategorie`, `imagecategorie`, `nbAchat`) VALUES
(1, 'cremerie', 'les produits du lait', 'http://10.0.2.2/Kaddechphp/pdt/creme.jpg', 742),
(2, 'sugele', 'denrees alimentaires surgelees', 'http://10.0.2.2/Kaddechphp/pdt/surgele.jpg', 117),
(4, 'Parfumerie', 'produits de beauté ou de toilette', 'http://10.0.2.2/Kaddechphp/pdt/par.jpg', 69),
(5, 'TV/HiFi', 'electronique grand public', ' 	http://10.0.2.2/Kaddechphp/pdt/tv.jpg', 110),
(6, 'bagagerie', 'les portes bagages ', 'http://10.0.2.2/Kaddechphp/pdt/bag.jpg', 52);
...
(3, 13, 1000, NULL),
(3, 14, 920, NULL),
(12358967, 14, 374, '2013-08-07 00:00:00'),
(15637475, 14, 123, '2013-08-28 09:28:39');
...
INSERT INTO `produit` (`idCategorie`, `iidProduit`, `nomProduit`, `imageProduit`, `descriptionProduit`, `dateAjout`, `nbAchat`) VALUES
(1, 1, 'dunup', 'http://10.0.2.2/Kaddechphp/pdt/surgele.jpg', 'yaourt ÃƒÆ’Ã‚Â  boire', '0000-00-00 00:00:00', 34),
(1, 2, 'yogo', 'http://10.0.2.2/Kaddechphp/pdt/surgele.jpg', 'yaourt classique', '0000-00-00 00:00:00', 54),
(2, 3, 'safia', 'http://10.0.2.2/Kaddechphp/pdt/surgele.jpg', 'eau minerale', '2013-04-15 00:00:00', 453),
(5, 12358967, 'Home Cinema', 'http://10.0.2.2/Kaddechphp/cat/ord.jpg', 'EAU DH 3120 S-5.1 canaux', NULL, 30),
(5, 12549367, 'Plasma sumsung', 'http://10.0.2.2/Kaddechphp/cat/t.jpg', 'Ps 43 E 450-43', NULL, 12),
(5, 15637475, 'PC Portable ACER', 'http://10.0.2.2/Kaddechphp/cat/pc.jpg', 'E1-531 processeur Intel dual core', NULL, 24),
(5, 32001569, 'camera numerique', 'http://10.0.2.2/Kaddechphp/cat/ca.jpg', 'Ecran LCD 2.7', NULL, 54),
(4, 35480039, 'UDV', 'http://10.0.2.2/Kaddechphp/cat/u.jpg', 'eau de parfun', NULL, 33),
(5, 35879317, 'GSM', 'http://10.0.2.2/Kaddechphp/cat/i.jpg', 'GSM SONY ERECSON WT 13i', '2013-07-09 00:00:00', 591),
(1, 65890015, 'Mozzarella', 'http://10.0.2.2/Kaddechphp/cat/moz.jpg', 'Mozzarella Pizzailo souani', NULL, 602);
